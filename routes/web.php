...
Route::post('/threads/{channel}/{thread}/subscriptions', 'ThreadSubscriptionsController@store')->middleware('auth')->name('subscriptions.store');
Route::delete('/threads/{channel}/{thread}/subscriptions', 'ThreadSubscriptionsController@destroy')->middleware('auth')->name('subscriptions.destroy');
...
Route::delete('/profiles/{user}/notifications/{notificaton}', 'UserNotificationsController@destroy')->name('user-notifications.destroy');
